...
Η έκδοση v0.2 του Project description περιγράφει πιο αναλυτικά τη λειτουργία του έργου μας καθώς και μία πρόσθετης λειτουργίας (το hub του επαγγελματία) που προήλθε κατά τη δημιουργία των use cases. Επίσης προσθέσαμε παραπάνω mock-up screens μετά από υπόδειξη του angel
